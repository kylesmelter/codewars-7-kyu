...
function takeUmbrella(weather, chance) {
    // We'll use an if-conditional to make sure 'true' is returned in all the
    // correct scenarios, and false if not
    if(weather === 'rainy' || weather === 'cloudy' && chance > 0.20 || weather === 'sunny' && chance > 0.50) {
      return true;
    } else {
      return false;
    };
