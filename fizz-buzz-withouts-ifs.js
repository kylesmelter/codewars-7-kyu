...
const fizzBuzz = n => {
    // We'll just use while-loops!
    while(n % 5 === 0 && n % 3 === 0) return 'FizzBuzz';
    while(n % 3 === 0) return 'Fizz';
    while(n % 5 === 0) return 'Buzz';
    // When the parameter, 'n,' isn't divisible by 3 or 5, we'll just return it
    return n;
};