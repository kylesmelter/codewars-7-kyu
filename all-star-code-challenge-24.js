...
function hypotenuse(a, b){
    // The Pythagorean Theorem is a^2 + b^2 = c^2, with a and b being the legs, and c being the
    // hypotenuse. So to find the hypotenuse all we need to do is find the square root of the sum
    // of a^2 + b^2
    return Math.sqrt(Math.pow(a, 2) + Math.pow(b, 2));  
};
  
  function leg(c, a){
    // Using the same equation, to find the length of a leg all we need to do is find the square root
    // of the product of c^2 - a^2
